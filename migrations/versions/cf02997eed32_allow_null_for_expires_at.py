...
Revision ID: cf02997eed32
Revises: 120cafe94a8d
Create Date: 2025-03-17 02:11:42.797770
...
revision = 'cf02997eed32'
down_revision = '120cafe94a8d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('product', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('product_type', sa.Enum('NEW', 'STOCK', 'USED', 'NEEDS_REPAIR', name='producttype'), nullable=True))
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], name='message_ibfk_3'),
